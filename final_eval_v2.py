"""
ACT-VLA Evaluation Script (v2)
===============================
Evaluates the trained ACT policy on the Robosuite Lift task.
The cube spawns randomly each episode; a spawn-delta correction is applied
to compensate for distribution shift between training and eval positions.

See final_eval_v3.py for a deterministic variant that fixes the cube spawn
position via UniformRandomSampler for more controlled benchmarking.
